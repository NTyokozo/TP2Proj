...
package com.Nobubele.TestPrinciple.testLSP;
...
public class testObey {
    public static MovieGenreInterface moviet;
    ...
    public void TestLSP() 
    {
        ...
        Assert.assertNotSame(moviet.genre(), "Leon Schuster your country needs you" + "100:00" + " Comedy", "Not the same");
    }
    ...
    public static void setUpClass() throws Exception 
    {
         ...
         moviet =(MovieGenreInterface)ctx.getBean("TestLSP");
    }
