...
package com.Nobubele.TestPrinciple.testSRP;
...
{
        public static RomMoviez moviet;
    ...
    //
     ...
     public void TestSRP() 
     {
         Assert.assertEquals(moviet.totalPrice(), 57.01, 57);
     }
    ...
    public static void setUpClass() throws Exception
    {
        ctx = new AnnotationConfigApplicationContext(TestConfig.class);
         moviet =(RomMoviez)ctx.getBean("TestSRP");
    }
